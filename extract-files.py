...
module = ExtractUtilsModule(
    'macanc-camera',
    'oneplus',
    device_rel_path='device/oneplus/macanc-camera',
...
CUSTOM_SOONG_BEGIN = "// BEGIN macanc-camera CUSTOM SOONG MODULES"
CUSTOM_SOONG_END = "// END macanc-camera CUSTOM SOONG MODULES"
...
def write_custom_android_bp():
    ...
    android_bp = top / "vendor" / "oneplus" / "macanc-camera" / "Android.bp"
